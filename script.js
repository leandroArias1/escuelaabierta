    ...
    fetch('alumnos.json')
        ...
        .then(data => {
            ...
            if (!validAlumno) {
                ...
                const usuarioId = validAlumno.id; // Utiliza el ID del JSON
                ...
                if (escaneos < 2) {
                    ...
                    window.location.href = 'invitacion.html?nombre=' + encodeURIComponent(nombre) +
                                          '&apellido=' + encodeURIComponent(apellido) +
                                          '&grado=' + encodeURIComponent(curso) +
